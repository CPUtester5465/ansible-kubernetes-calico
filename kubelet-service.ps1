...
else
{
    ...
    $argList += "--cloud-provider=""external"""
    $argList += "--kube-reserved=""cpu=250m,memory=500Mi"""
    $argList += "--system-reserved=""cpu=250m,memory=500Mi"""
    $argList += "--windows-priorityclass=""HIGH_PRIORITY_CLASS"""
